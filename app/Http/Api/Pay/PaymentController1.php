...
//        require base_path('vendor/Alipay/aop/AopClient.php');
        ...
        $body = '测试支付';//商品描述，可空
        $timeExpress = '10m';
        $notify_url = 'https://ytapi.56cold.com/alipay/notify';//异步通知地址
        $return_url = "https://front.56cold.com/tms/pay/pay_success?order_id=".$out_trade_no."&from=2";//同步跳转
        //构造参数
...
//        print_r($result); // result中就是返回的各种信息信息，成功的情况下也包含很重要的prepay_id
    ...
    public function paymentWechat(Request $request){
        ...
        $noturl = 'https://api.56cold.com/alipay/paymentWechatNotify';
...
//            $order_update['order_status'] = 6;
    ...
    public function appWechat(Request $request){
        ...
        include_once base_path( '/vendor/wxAppPay/weixin.php');
        $out_trade_no = $data['ordernumber'];
        $noturl = 'https://api.56cold.com/alipay/appWechat_notify';
        $appid = 'wxe2d6b74ba8fa43e7';
        $mch_id = '1481595522';
        $notify_url = $noturl;
        $key = 'FdzK0xScm6GRS0zUW4LRYOak5rZA9k3o';
...
//        $price = 0.01;
        ...
        //运单支付
        $subject = '订单支付';
        $notifyurl = "https://ytapi.56cold.com/alipay/onlineApipay_notity";
        $aop->alipayrsaPublicKey = '';
        $bizcontent = json_encode([
            'body' => '支付宝支付',
            'subject' => $subject,
...
//        $data['price'] = $price = 0.01;
        ...
        include_once base_path( '/vendor/wxAppPay/weixin.php');
        $notify_url = 'https://ytapi.56cold.com/alipay/onlineWechat_notify';
        $appid = 'wx1ed6b733675628df';
        $mch_id = '1487413072';
        $key = '011eaf63e5f7944c6a979de570d44aaa';
        $wechatAppPay = new \wxAppPay($appid,$mch_id,$notify_url,$key);
