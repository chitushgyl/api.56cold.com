...
//        dd($data);
    ...
    public function orderPage(Request $request){
        ...
        $select=['self_id','group_name','company_name','create_user_name','create_time','use_flag','order_type','order_status','pay_type','pay_state','app_flag',
            ...
            'good_name','good_number','good_weight','good_volume','gather_shi_name','send_shi_name','send_qu_name','car_type','clod','send_time','gather_time'];
