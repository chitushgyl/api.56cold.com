...
//        $order_status = 2;
        ...
        if($validator->passes()) {
            ...
            $select=['self_id','receiver_id','company_name','create_time','create_time','group_name','group_code','order_type',
                ...
                'good_info','good_number','good_weight','good_volume','total_money','send_time','gather_time'];
