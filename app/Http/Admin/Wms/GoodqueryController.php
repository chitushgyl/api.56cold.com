...
class GoodqueryController extends CommonController{

    /***   商品统计      /wms/goodquery/goodqueryList
     */
    public function  goodqueryList(Request $request){
    ...
    /***    商品统计分页      /wms/goodquery/goodqueryPage
     */
    public function goodqueryPage(Request $request){
        /** 接收中间件参数**/
